	...
	<body>
		<div data-role="page" id="page1">
			<div data-theme="b" data-role="header">
				<a data-role="button" href="administrador_turma_vincular_aluno.php" data-icon="back" data-iconpos="left"
			...
			<div data-role="content">
				...
				<form id="formulario" action="vincular_aluno_turma.php" method="POST" data-ajax="false">
					<div data-role="fieldcontain">
						<label for="selectmenu3"> Aluno(a)/s: </label>
						<select id="selectmenu3" name="codigo_aluno[]" data-native-menu="false" multiple="multiple">
							<?php
							if ($lista_aluno) {
						...
						jQuery.ajax({
							...
							success : function(data) {
								...
								if (data.check == '1') {
									...
									location.href = "administrador_turma_vincular_aluno.php";
								} else {
