	...
	<body>
		...
		<div data-role="page" id="page1">
			<div data-theme="b" data-role="header">
				<a data-role="button" data-direction="reverse" href="administrador.php"
			...
			<div data-role="content">
				...
				<div data-role="controlgroup">
					<a data-role="button" enabled="false" href="administrador_consulta.php" data-icon="plus" data-iconpos="left"> Administradores </a>
					<a data-role="button" href="copia_seguranca.php" data-icon="alert" data-iconpos="left">Cópia de segurança</a>
				</div>
			</div>
