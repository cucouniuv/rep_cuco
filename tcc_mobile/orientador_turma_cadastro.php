	...
	<body>
		...
		<div data-role="page" id="page1">
			...
			<div data-role="content">
				<form id="formulario" action="turma_incluir.php" method="POST">
					<p>O orientador pode cadastrar novas turmas, mas não é realizado o vínculo a ela. Os administradores fazem este processo.</p>
						...
						jQuery.ajax({
							...
							success : function(data) {
								...
								if (data.check == '1') {
									...
									location.href = "orientador_turma.php";
								} else {
