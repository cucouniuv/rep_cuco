			...
			<div data-role="content">
				<form id="formulario">
						...
						<select id="selectmenu1" name="id_evento" data-mini="false" required>
							...
							if ($lista_evento) {
								while ($row = mysql_fetch_array($lista_evento)) {
									echo '<option value="' . $row['id_evento'] . '">';
									echo $row['descricao'];
									echo '</option>';
								}
							}
					...
					<div data-role="fieldcontain">
						...
						<input name="minimo_horas" id="textinput1" placeholder="HH.MM" value=""
						type="text" pattern="[0-9]{0,1}[0-9]{0,1}[0-9]{1}\.[0-5]{1}[0-9]{1}" required>
					</div>
