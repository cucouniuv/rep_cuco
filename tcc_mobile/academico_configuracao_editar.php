	...
	<body>
		...
		<div data-role="page" id="page1">
			<div data-theme="b" data-role="header">
				<a data-role="button" href="academico_configuracao.php" data-icon="back" data-iconpos="left"
				...
				<form id="cadastro">
					...
					<div data-role="fieldcontain" id="num_matricula_aluno">
						<fieldset data-role="controlgroup">
							...
							<input name="num_matricula" id="num_matricula_aluno" pattern="[0-9]{8,11}" maxlength="11" placeholder="" value="<?php echo $rp['num_matricula_aluno']; ?>"
							type="text" required>
						</fieldset>
					</div>					
						...
						jQuery.ajax({
							...
							success : function(data) {
								if (data.check == '1') {
									...
									location.href = "academico_configuracao.php";
								} else {
