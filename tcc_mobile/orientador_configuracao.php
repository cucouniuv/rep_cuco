	...
	<body>
		...
		<div data-role="page" id="page1">
			<div data-theme="b" data-role="header">
				<a data-role="button" data-direction="reverse" href="orientador.php"
			...
			<div data-role="content">
				<form id="formulario">
					...
					<input type="submit" id="enviar" name="enviar" data-icon="check" data-iconpos="left" value="Alterar senha">
					<div id="resposta"></div>
				</form>
				<a data-role="button" href="orientador_configuracao_editar.php"
