...
$query .= " where exists(select at.id_turma";
...
<html>
	...
	<div data-role="page" id="page1">
		...
		<div data-role="content">
			<form id="formulario" method="POST" action="relatorio_academico.php" data-ajax="false">
				...
				<div data-role="fieldcontain">
					<label for="textinput1"> Código do acadêmico (início)</label>
					<input name="codigo_inicio" id="textinput1" placeholder="" value="0" type="number" required>
				</div>
				<div data-role="fieldcontain">
					<label for="textinput2"> Código do acadêmico (término)</label>
