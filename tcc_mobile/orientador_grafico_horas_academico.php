...
<html>
	...
	<div data-role="page" id="page1">
		<div data-theme="b" data-role="header">
			<h3> Gráfico de acadêmicos </h3>
			<a data-role="button" data-theme="b" href="orientador_grafico.php" data-icon="back"
			data-iconpos="left" class="ui-btn-left"> Voltar </a>
		</div>
		<div data-role="content">
			<form id="formulario" method="POST" action="grafico_orientador_alunos.php" data-ajax="false">
				...
				<input id="imprimir" type="submit" data-icon="check" data-iconpos="left" value="Gerar">	
			</form>
		</div>
	</div>
	</body>
